...
export class ControllerScreen extends FullscreenMenu {
    ...
    getNextAvailableInput() {
        if (this.controller1.selectedInput == 'none')
            return this.controller1;
        if (this.controller2.selectedInput == 'none')
            return this.controller2;
        if (this.controller3.selectedInput == 'none')
            return this.controller3;
        if (this.controller4.selectedInput == 'none')
            return this.controller4;
        return;
    }
    getGamepadConnected(gamepadIndex) {
        if (this.controller1.selectedInput == 'gamepad-' + gamepadIndex)
            return this.controller1;
        if (this.controller2.selectedInput == 'gamepad-' + gamepadIndex)
            return this.controller2;
        if (this.controller3.selectedInput == 'gamepad-' + gamepadIndex)
            return this.controller3;
        if (this.controller4.selectedInput == 'gamepad-' + gamepadIndex)
            return this.controller4;
        return;
    }
}
customElements.define('ce-controller-screen', ControllerScreen);
//# sourceMappingURL=ControllerScreen.js.map